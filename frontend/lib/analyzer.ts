...
export function exportToCSV(result: AnalysisResult): string {
  const rows = [
    ...
    ["Risk Score", result.score.toString()],
    ["Risk Level", result.riskLevel],
    ["Characters", result.metrics.textLength.characters.toString()],
    ["Words", result.metrics.textLength.words.toString()],
    ["Read Time", result.metrics.textLength.readTime],
    ["Capital Letters %", result.metrics.capitalLetters.percentage.toString()],
    ["Special Characters", result.metrics.specialCharacters.total.toString()],
    ["URLs Found", result.metrics.urls.count.toString()],
    ["Suspicious Words", result.metrics.suspiciousWords.count.toString()],
    ["Urgency Flags", result.riskCategories.urgency.count.toString()],
    ["Shady Flags", result.riskCategories.shady.count.toString()],
    ["Overpromise Flags", result.riskCategories.overpromise.count.toString()],
    ["Unnatural Flags", result.riskCategories.unnatural.count.toString()],
  ]
